...
from sklearn.metrics import roc_curve, auc, confusion_matrix, brier_score_loss, accuracy_score, precision_score, recall_score, f1_score
...
def train_and_evaluate(study, dataset, encoder_path, result_dir, n_runs=20):
    ...
    runs_path = os.path.join(result_dir, 'classification_reports_runs.txt')
